...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Catedra.comisiones'
        db.add_column(u'main_alumno_catedra', 'comisiones',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='comisiones', to=orm['main_alumno.Comision']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Catedra.comisiones'
        db.delete_column(u'main_alumno_catedra', 'comisiones_id')
    ...
    models = {
        ...
        u'main_alumno.catedra': {
            ...
            'comisiones': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comisiones'", 'to': u"orm['main_alumno.Comision']"}),
