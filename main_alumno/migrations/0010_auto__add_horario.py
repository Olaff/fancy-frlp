...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_alumno_horario', (
            ...
            ('comision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main_alumno.Comision'])),
    ...
    models = {
        ...
        u'main_alumno.catedra': {
            ...
            'comisiones': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main_alumno.Comision']", 'through': u"orm['main_alumno.Horario']", 'symmetrical': 'False'}),
