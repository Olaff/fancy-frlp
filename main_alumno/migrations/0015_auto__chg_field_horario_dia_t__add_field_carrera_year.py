...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Horario.dia_t'
        db.alter_column(u'main_alumno_horario', 'dia_t', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
        # Adding field 'Carrera.year'
        db.add_column(u'main_alumno_carrera', 'year',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Horario.dia_t'
        db.alter_column(u'main_alumno_horario', 'dia_t', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Deleting field 'Carrera.year'
        db.delete_column(u'main_alumno_carrera', 'year')
    ...
    models = {
        ...
        u'main_alumno.horario': {
            ...
            'comision': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'horarios'", 'to': u"orm['main_alumno.Comision']"}),
