...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Horario.comision'
        db.add_column(u'main_alumno_horario', 'comision',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['main_alumno.Comision']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Horario.comision'
        db.delete_column(u'main_alumno_horario', 'comision_id')
